...
similar_projects = [
  ...
  { :name => 'Ace',          :lang => 'Ruby', :url => 'https://github.com/botanicus/ace' },
  { :name => 'Bonsai',       :lang => 'Ruby', :url => 'http://tinytree.info/' },
  { :name => 'Deplot',       :lang => 'Ruby', :url => 'https://github.com/cdn64/deplot' },
  ...
  { :name => 'Machined',     :lang => 'Ruby', :url => 'https://github.com/petebrowne/machined' },
  { :name => 'Middleman',    :lang => 'Ruby', :url => 'http://github.com/tdreyno/middleman' },
  { :name => 'Pith',         :lang => 'Ruby', :url => 'https://github.com/mdub/pith' },
  ...
  { :name => 'Graze',                   :lang => 'C#',                :url => 'https://github.com/mikoskinen/graze' },
  { :name => 'Hakyll',                  :lang => 'Haskell',           :url => 'http://jaspervdj.be/hakyll/' },
  { :name => 'Hastie',                  :lang => 'Go',                :url => 'https://github.com/mkaz/hastie' },
  { :name => 'Hyde',                    :lang => 'Python',            :url => 'http://github.com/lakshmivyas/hyde' },
  { :name => 'jkl',                     :lang => 'Go',                :url => 'https://github.com/drone/jkl' },
  ...
  { :name => 'Pelican',                 :lang => 'Python',            :url => 'https://github.com/ametaireau/pelican/' },
  ...
  { :name => 'Punch',                   :lang => 'Node.js',           :url => 'https://github.com/laktek/punch' },
  { :name => 'Quill',                   :lang => 'Node.js',           :url => 'http://justquillin.com/' },
  { :name => 'Rizzo',                   :lang => 'Groovy',            :url => 'https://github.com/fifthposition/rizzo/' },
  { :name => 'Ruroh',                   :lang => 'language-agnostic', :url => 'http://ruhoh.com/' },
  { :name => 'Second Crack',            :lang => 'PHP',               :url => 'http://www.marco.org/secondcrack' },
  { :name => 'Speechhub',               :lang => 'Python',            :url => 'https://github.com/alvesjnr/speechhub' },
